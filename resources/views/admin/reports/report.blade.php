<x-admin-layout>
    ...
    <script src="{{ asset('assets/js/add-report.js') }}"></script>
    <div class="py-2">
        <div class="h-full md:h-50 lg:h-50 m-4">
            <div class="bg-white overflow-auto md:overflow-scroll shadow-md sm:rounded-lg">
                <div class="p-6 relative bg-gray-200 border-b border-white lg:w-full md:w-1/2">

                    <caption
                        class="p-5 text-lg font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                        <h1 class="font-bold" style="font-size: 20px">Reporting Person </h1>
                    </caption>
                    ...
                    <table class="table table-bordered table-auto text-[10px]">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Family Name</th>
                            ...
                            <tr>
                                @foreach ($users as $users)
                                    ...
                                    <td class="flex justify-center">
                                        ...
                                        <button class="btn btn-success mx-2">View</button>
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-gray-800 rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                        <label for="name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Family Name</label>
                    ...
                    <div>
                        <label for="password"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Village/Sitio</label>
                        <input type="text" name="password" id="password"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="password" required>
                    </div>
                    ...
                    <div>
                        <label for="password"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Town/City</label>
                        <input type="text" name="password" id="password"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="password" required>
                    </div>
