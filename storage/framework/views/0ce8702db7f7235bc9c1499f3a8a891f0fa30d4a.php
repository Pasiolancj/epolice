        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-gray-800 rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 text-white">
                    ...
                    <p>Role: <?php echo e($users->is_admin ? 'Admin' : 'Officer'); ?></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn bg-gray-500 text-white"
                        data-modal-toggle="viewModal">Close</button>
                </div>
                </form>
            </div>
        </div>
    </div><?php /**PATH C:\xampp\htdocs\epolice\resources\views/show.blade.php ENDPATH**/ ?>